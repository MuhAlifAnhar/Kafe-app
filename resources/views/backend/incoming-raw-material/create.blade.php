...
@section('title', 'Tambah Bahan Baku Masuk')
    ...
    <div class="container-fluid py-4">
        <nav aria-label="breadcrumb pb-5">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                ...
                <li class="breadcrumb-item text-sm text-dark active pb-3" aria-current="page">Tambah Bahan Baku Masuk</li>
            </ol>
        </nav>
        <div class="row">
            <div class="col-12">
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                            <div class="d-flex justify-content-between">
                                <h6 class="text-white text-capitalize ps-3">Tambah Bahan Baku Masuk</h6>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body px-0 pb-2">
                        <form action="{{ route('panel.incoming-raw-material.store') }}" method="post" class="p-3">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="date"
                                            ...
                                            value="{{ old('tanggal_pembelian') }}" name="tanggal_pembelian"
                                            id="tanggal_pembelian" placeholder="Masukkan tanggal pembelian">
